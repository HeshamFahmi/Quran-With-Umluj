...
import '../gaardresult/gaardcell.dart';
...
class _GaardResultsState extends State<GaardResults> {
  ...
  String url = "https://api.quranumluj.org.sa/api/InventoryApi/SaveInventory";
  ...
  getAssetsByLocation(String locationsID) async {
    ...
    var request = http.Request(
        'GET',
        Uri.parse(
            'https://api.quranumluj.org.sa/api/InventoryApi/GetAssetsBylocation'));
