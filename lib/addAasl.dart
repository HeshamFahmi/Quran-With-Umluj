...
class _AddAaslState extends State<AddAasl> {
  ...
  String url = "https://api.quranumluj.org.sa/api/assetapi/SaveAsset";

  String uploadImageUrl =
      "https://api.quranumluj.org.sa/api/Uploader/upload/AssetImages";
  ...
  Future<ClassificationModel> getAssetClassificationData() async {
    ...
    var response = await http.get(
        Uri.http(
            'api.quranumluj.org.sa', 'api/assetapi/GetAssetClassifications'),
  ...
  Future<SupplierModel> getAssetSupplierData() async {
    ...
    String token = prefs.getString('bearer');
    var response = await http.get(
        Uri.http('api.quranumluj.org.sa', 'api/assetapi/GetAssetSuppliers'),
        headers: {'Authorization': 'Bearer $token'});
  ...
  Future<LocationModel> getAssetLocationData() async {
    ...
    String token = prefs.getString('bearer');
    var response = await http.get(
        Uri.http('api.quranumluj.org.sa', 'api/assetapi/GetLocations'),
        headers: {'Authorization': 'Bearer $token'});
